...
public class Program {
	public static void main(String[] args) {
		...
		// crio um novo solver que onde a logica eh aplicada passando tudo por parametros para serem trabalhados lá dentro da calsse
		Solver solver = new Solver(producoesList, SimboloPartida, palavraSerTestadaArray, palavraSerTestada,
				prodVazias);
		// nn sei se tem necessidade disso aqui ( remover ? )
		System.out.println(solver.doIt());
